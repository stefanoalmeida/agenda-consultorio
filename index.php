    ...
    <div class="grid grid-cols-3 items-center justify-center p-4 h-screen">
        <div class="col-span-1">
            ...
            <form action="" class="flex flex-col items-center justify-center gap-4 w-96" method="POST">
                <input
                        ...
                        id="data-agendamento"
                >
                <select name="sala" id="" class="w-full p-2 bg-transparent border-2 border-gray-400 rounded-lg text-gray-500 focus:outline-purple-700">
                ...
                <select name="profissional" id="" class="w-full p-2 bg-transparent border-2 border-gray-400 rounded-lg text-gray-500 focus:outline-purple-700">
                    <?php
                ...
                <button title="Buscar agendamentos" class="w-full rounded-lg bg-purple-700 text-white font-bold p-2 hover:bg-purple-600">
                    Buscar agendamentos
                </button>
                <a href="./index.php"
                   title="Limpar filtros"
                   class="w-full text-center rounded-lg bg-transparent border-2 border-purple-300 text-purple-700 font-bold p-2"
                >
                    Limpar filtros
                </a>
            </form>
        ...
        <div class="w-full col-span-2 flex flex-col gap-4">
            <div class="flex items-center gap-4">
                <h2 class="font-bold text-purple-900 text-xl uppercase">Agendamentos: <?= date("d/m/Y", strtotime($day)) ?></h2>
                <a
