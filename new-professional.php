...
<h2 class="font-bold text-purple-900 text-xl uppercase">Novo profissional</h2>

<div class="w-96">
    <form action="./source/commands/create_professional.php" method="POST" class="flex flex-col gap-4">
        <input type="text" placeholder="Digite o nome do profissional" name="nome" class="p-2 bg-transparent border-2 border-gray-400 rounded-lg text-gray-500 focus:outline-purple-700">
        <select name="especialidade" id="" class="p-2 bg-transparent border-2 border-gray-400 rounded-lg text-gray-500 focus:outline-purple-700">
